...
export const Works = [
  ...
  },
  {
    ...
    imgUrl: 'images/arakelians-drive.png',
    links: [
      {
        name: 'Home',
        url: 'https://arakelians-drive.am',
      },
    ],
    created:
      'Next.js, Typescript, MySql, Prisma, React JS, TypeScript, Hero UI, Tailwind CSS',
    description:
      'Arakelians Drive — одна из самых успешных автошкол в Армении, специализирующаяся на получении водительских прав. Наша автошкола предлагает комплексную программу обучения, включающую как теоретические, так и практические занятия. 98% наших студентов успешно сдают экзамен на водительские права с первой попытки благодаря профессиональному подходу и высококачественному обучению. Мы используем эффективную методологию, которая позволяет быстро и надежно освоить навыки вождения. Наша автошкола оснащена современными автомобилями с системой двойного управления, что обеспечивает безопасное обучение. Наши инструкторы — опытные специалисты с многолетним стажем, которые используют индивидуальный подход и помогают каждому студенту достичь успеха. Мы предлагаем гибкий график, доступные цены и гарантированный результат.',
  },
  {
    name: 'Galamat',
    slug: 'galamat',
  ...
  },
  {
    name: 'UlibkaProfi',
    slug: 'ulibkaprof',
    imgUrl: 'images/ulibkaprofi.jpg',
    links: [
      {
        name: 'Home',
        url: 'https://ulibkaprofi.ru/',
      },
    ],
    created: 'HTML CSS JS',
    description:
      'Улыбка Профи — стоматологическая клиника в г. Раменское с полным спектром услуг: имплантация, протезирование, терапия, хирургия, пародонтология и гигиена. Опытные врачи, современное оборудование и прозрачный план лечения без навязывания лишних услуг.',
  },
  {
    name: 'Kettik-travel',
    slug: 'kettik-travel',
