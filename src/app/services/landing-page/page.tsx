...
export const metadata: Metadata = {
  title:
    'Лендинг Пейдж - Создание Одностраничных Сайтов для Продаж | Torgomyan.Studio',
  description:
    'Профессиональное создание лендинг пейдж для увеличения конверсии и продаж. Одностраничные сайты с высокой конверсией. Заказать лендинг.',
  keywords:
    'лендинг пейдж, лендинг, одностраничный сайт, landing page, создание лендинга, лендинг под ключ, продающий лендинг, лендинг цена, заказать лендинг, лендинг для бизнеса',
  alternates: {
    canonical: '/services/landing-page',
  },
  openGraph: {
    title: 'Лендинг Пейдж - Создание Одностраничных Сайтов для Продаж',
    description:
      'Профессиональное создание лендинг пейдж с высокой конверсией для вашего бизнеса.',
    type: 'website',
  },
};
      ...
      <SEOMarketingBlocks
        ...
        faq={[
          ...
          },
          {
            ...
            answer:
              'Стоимость лендинга зависит от сложности дизайна, количества блоков и необходимых интеграций. Базовый лендинг начинается от 150,000 рублей. Свяжитесь с нами для получения точного расчета.',
          },
          {
