...
export const metadata: Metadata = {
  ...
  description:
    'Техническая поддержка и обслуживание сайтов. Обновление контента, исправление ошибок, резервное копирование. Заказать техническую поддержку сайта.',
  keywords:
    'техническая поддержка сайта, обслуживание сайта, поддержка сайтов, техническая поддержка цена, обслуживание сайтов, поддержка веб сайта, администрирование сайта',
  alternates: {
    canonical: '/services/technical-support',
  },
  openGraph: {
    title: 'Техническая Поддержка Сайтов - Обслуживание и Поддержка',
    description:
      'Профессиональная техническая поддержка и обслуживание сайтов для стабильной работы вашего бизнеса.',
    type: 'website',
  },
};
