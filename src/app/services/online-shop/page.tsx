        ...
        faq={[
          {
            ...
            answer:
              'Стоимость зависит от количества товаров, функциональности и интеграций. Базовый интернет-магазин начинается от 400,000 рублей. Свяжитесь с нами для получения детального расчета.',
          },
          {
