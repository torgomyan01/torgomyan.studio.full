...
export const metadata: Metadata = {
  title:
    'Корпоративный Сайт - Разработка Сайтов для Компаний | Torgomyan.Studio',
  description:
    'Профессиональная разработка корпоративных сайтов для компаний. Современные решения для бизнеса с полным функционалом. Заказать корпоративный сайт.',
  keywords:
    'корпоративный сайт, корпоративный веб-сайт, сайт для компании, разработка корпоративного сайта, корпоративный сайт цена, заказать корпоративный сайт, сайт компании, бизнес сайт',
  alternates: {
    canonical: '/services/corporate-website',
  },
  openGraph: {
    title: 'Корпоративный Сайт - Разработка Сайтов для Компаний',
    description:
      'Профессиональная разработка корпоративных сайтов с полным функционалом для вашего бизнеса.',
    type: 'website',
  },
};
      ...
      <SEOMarketingBlocks
        ...
        faq={[
          ...
          },
          {
            ...
            answer:
              'Стоимость зависит от количества страниц, сложности дизайна, функциональности и интеграций. Базовый корпоративный сайт начинается от 300,000 рублей. Свяжитесь с нами для получения детального расчета.',
          },
          {
