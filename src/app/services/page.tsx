...
export const metadata: Metadata = {
  ...
  description:
    'Профессиональные услуги по разработке сайтов, веб-приложений, SEO-продвижению, дизайну интерфейсов и технической поддержке. Полный спектр веб-услуг для вашего бизнеса.',
  keywords:
    'разработка сайтов, создание сайтов, веб-разработка, SEO продвижение, дизайн UI/UX, интернет-магазин, лендинг, корпоративный сайт, хостинг, домены, техническая поддержка',
  alternates: {
    canonical: '/services',
  },
  openGraph: {
    title: 'Услуги - Разработка сайтов и веб-приложений',
    description:
      'Профессиональные услуги по разработке сайтов, веб-приложений, SEO-продвижению и дизайну интерфейсов',
    type: 'website',
  },
};
