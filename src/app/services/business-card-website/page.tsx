...
export const metadata: Metadata = {
  title:
    'Сайт-Визитка - Создание Простых и Эффективных Сайтов | Torgomyan.Studio',
  description:
    'Создание сайта-визитки для малого бизнеса. Простой, быстрый и эффективный сайт по доступной цене. Идеально для старта бизнеса в интернете.',
  keywords:
    'сайт визитка, сайт-визитка, создание сайта визитки, простой сайт, сайт для малого бизнеса, сайт визитка цена, заказать сайт визитку, дешевый сайт, сайт под ключ',
  alternates: {
    canonical: '/services/business-card-website',
  },
  openGraph: {
    title: 'Сайт-Визитка - Создание Простых и Эффективных Сайтов',
    description:
      'Создание сайта-визитки для малого бизнеса по доступной цене. Идеальное решение для старта в интернете.',
    type: 'website',
  },
};
      ...
      <SEOMarketingBlocks
        ...
        faq={[
          ...
          },
          {
            ...
            answer:
              'Стоимость сайта-визитки начинается от 80,000 рублей. Цена зависит от количества страниц, сложности дизайна и дополнительных функций. Свяжитесь с нами для получения точного расчета.',
          },
          {
