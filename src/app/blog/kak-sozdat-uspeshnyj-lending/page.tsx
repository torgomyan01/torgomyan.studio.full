...
export const metadata: Metadata = {
  ...
  description:
    'Пошаговое руководство по созданию эффективной лендинг-страницы, которая конвертирует посетителей в клиентов. Практические советы по дизайну, контенту и оптимизации конверсии.',
  keywords:
    'лендинг страница, создание лендинга, эффективный лендинг, конверсия лендинга, как создать лендинг, продающий лендинг, создание лендинг пейдж, конверсионный лендинг',
  alternates: {
    canonical: 'https://torgomyan.studio/blog/kak-sozdat-uspeshnyj-lending',
  },
  openGraph: {
