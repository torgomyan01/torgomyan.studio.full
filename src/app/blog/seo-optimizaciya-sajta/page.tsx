...
export const metadata: Metadata = {
  ...
  description:
    'Полное руководство по SEO-оптимизации сайта. Узнайте, как повысить позиции в поисковых системах и привлечь органический трафик. Практические советы от профессионалов.',
  keywords:
    'SEO оптимизация, поисковая оптимизация, продвижение сайта, SEO основы, SEO практика, оптимизация для поисковых систем, SEO оптимизация сайта, как продвинуть сайт, SEO руководство',
  alternates: {
    canonical: 'https://torgomyan.studio/blog/seo-optimizaciya-sajta',
  },
  openGraph: {
    title: 'SEO-оптимизация сайта: основы и практика',
    description:
      'Полное руководство по SEO-оптимизации сайта для повышения позиций в поисковых системах. Практические советы от профессионалов.',
    type: 'article',
    locale: 'ru_RU',
