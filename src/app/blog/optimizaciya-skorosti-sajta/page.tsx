...
export const metadata: Metadata = {
  ...
  description:
    'Практические советы по ускорению сайта. Как уменьшить время загрузки и улучшить пользовательский опыт. Методы оптимизации производительности сайта.',
  keywords:
    'оптимизация скорости сайта, ускорение сайта, скорость загрузки, производительность сайта, оптимизация производительности, как ускорить сайт, оптимизация скорости загрузки',
  alternates: {
    canonical: 'https://torgomyan.studio/blog/optimizaciya-skorosti-sajta',
  },
  openGraph: {
    title: 'Оптимизация скорости загрузки сайта',
    description:
      'Практические советы по ускорению сайта и улучшению производительности. Методы оптимизации времени загрузки.',
    type: 'article',
    locale: 'ru_RU',
