...
export const metadata: Metadata = {
  title:
    'Блог о Веб-Разработке | Статьи о Создании Сайтов и SEO | Torgomyan.Studio',
  description:
    'Экспертные статьи о веб-разработке, создании сайтов, SEO-оптимизации и выборе веб-студии. Практические советы и руководства от профессионалов. Читайте наш блог.',
  keywords:
    'блог о веб-разработке, статьи о создании сайтов, как выбрать веб-студию, SEO статьи, статьи о веб-дизайне, ошибки при создании сайта, руководство по созданию сайта, статьи о продвижении сайтов, блог веб-студии',
  alternates: {
    canonical: 'https://torgomyan.studio/blog',
  },
  openGraph: {
    title: 'Блог о Веб-Разработке | Статьи о Создании Сайтов и SEO',
    description:
      'Экспертные статьи о веб-разработке, создании сайтов, SEO-оптимизации и выборе веб-студии. Практические советы и руководства от профессионалов.',
    type: 'website',
    locale: 'ru_RU',
