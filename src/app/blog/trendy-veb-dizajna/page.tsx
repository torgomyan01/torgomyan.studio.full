...
export const metadata: Metadata = {
  ...
  description:
    'Актуальные тренды в веб-дизайне на 2024 год. Что будет популярно и как создать современный сайт. Обзор новых направлений в дизайне интерфейсов.',
  keywords:
    'тренды веб-дизайна, веб-дизайн 2024, современный дизайн, тренды дизайна, актуальный дизайн сайта, новые тренды веб-дизайна, тренды UI/UX дизайна 2024',
  alternates: {
    canonical: 'https://torgomyan.studio/blog/trendy-veb-dizajna',
  },
  openGraph: {
