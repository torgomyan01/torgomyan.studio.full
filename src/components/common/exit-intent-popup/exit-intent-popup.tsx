...
export default function ExitIntentPopup() {
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = (e: MouseEvent) => {
      ...
      // This prevents triggering on accidental mouse movements
      if (e.clientY <= 0) {
        setIsOpen(true);
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          {/* Backdrop */}
          <motion.div
            className="exit-intent-popup-backdrop"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          {/* Popup */}
          <div className="exit-intent-popup-wrapper">
            <motion.div
              className="exit-intent-popup-container"
            ...
            >
              ...
              {/* Content */}
              <div className="exit-intent-popup-content">
                ...
                <div className="exit-intent-actions">
                  ...
                  <div className="exit-intent-social-buttons">
                    <button
                      type="button"
                      className="exit-intent-social-btn telegram"
                    ...
                    <button
                      type="button"
                      className="exit-intent-social-btn whatsapp"
